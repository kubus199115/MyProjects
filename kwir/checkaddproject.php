<?php
	...
	if((!isset($_POST['title'])) || (!isset($_POST['descrip'])) || (!isset($_POST['conditions'])) || (!isset($_POST['producer'])) || (!isset($_POST['link']))) {
	...
	$sql = "insert into projects (title, descrip, conditions, producer, link) values ('".$title."', '".$descrip."', '".$conditions."', '".$producer."', '".$link."')";
	if (mysqli_query($con, $sql)) 
	{
		$info = "Udało się dodać projekt.";
	}
	else 
	{
		$info = "Nie udało się dodać projektu. Coś poszło nie tak:(";
	}
