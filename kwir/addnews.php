	...
	<div class="container">
		<div class="row">
		  <div class="col-xs-12">
			...
			<form action="checkaddnews.php" method="post">
				Tytuł: <br /><input type="text" size="50" maxlength="256" name="title" /> <br />
				Treść ogłoszenia: <br /><textarea cols="52" rows="10" maxlength="1024" name="content"></textarea> <br /> <br />
