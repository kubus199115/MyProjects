<?php
	...
	$sql = "delete from projects where id = ".$todelete;
	if (mysqli_query($con, $sql)) 
	{
		$info = "Udało się usunąć projekt.";
	}
	else 
	{
		$info = "Nie udało się usunąć projektu. Coś poszło nie tak:(";
	}
...
<html lang="pl">
	<head>
		...
		<title>PANEL ADMINA - USUWANIE PROJEKTU</title>
